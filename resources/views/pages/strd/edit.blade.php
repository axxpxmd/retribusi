                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="select2 form-control r-0 s-12" disabled id="id_rincian_jenis_pendapatan" name="id_rincian_jenis_pendapatan" autocomplete="off">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea type="text" disabled rows="3" name="uraian_retribusi" id="uraian_retribusi" class="form-control r-0 s-12" autocomplete="off" required>{{ $data->uraian_retribusi }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" disabled name="nmr_daftar" id="nmr_daftar" value="{{ $data->nmr_daftar }}" class="form-control r-0 s-12" autocomplete="off" required/>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <label for="nm_wajib_pajak" class="col-form-label s-12 col-sm-4 text-right">Nama<span class="text-danger ml-1">*</span></label>
                                                        <div class="col-md-8">
                                                            <input type="text" disabled name="nm_wajib_pajak" id="nm_wajib_pajak" value="{{ $data->nm_wajib_pajak }}" class="form-control r-0 s-12" autocomplete="off" required onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"/>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <label for="email" class="col-form-label s-12 col-sm-4 text-right">Email</label>
                                                        <div class="col-md-8">
                                                            <input type="email" disabled name="email" id="email" value="{{ $data->email }}" class="form-control r-0 s-12"/>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <label for="no_telp" class="col-form-label s-12 col-sm-4 text-right">No Telp</label>
                                                        <div class="col-md-8">
                                                            <input type="number" disabled name="no_telp" id="no_telp" value="{{ $data->no_telp }}" class="form-control r-0 s-12"/>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <label for="alamat_wp" class="col-form-label s-12 col-sm-4 text-right">Alamat<span class="text-danger ml-1">*</span></label>
                                                        <div class="col-md-8">
                                                            <textarea type="text" disabled rows="3" name="alamat_wp" id="alamat_wp" class="form-control r-0 s-12" autocomplete="off" required>{{ $data->alamat_wp }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <label for="lokasi" class="col-form-label s-12 col-sm-4 text-right">Lokasi<span class="text-danger ml-1">*</span></label>
                                                        <div class="col-md-8">
                                                            <textarea type="text" disabled rows="2" name="lokasi" id="lokasi" placeholder="Contoh: Ruko Sektor 1.2 BSD" class="form-control r-0 s-12" autocomplete="off" required>{{ $data->lokasi }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <label for="kecamatan_id" class="col-form-label s-12 col-sm-4 text-right">Kecamatan<span class="text-danger ml-1">*</span></label>
                                                        <div class="col-md-8">
                                                            <input type="text" disabled disabled id="kecamatan_id" value="{{ $data->kecamatan->n_kecamatan }}" class="form-control r-0 s-12" autocomplete="off"/>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <label for="kelurahan_id" class="col-form-label s-12 col-sm-4 text-right">Kelurahan<span class="text-danger ml-1">*</span></label>
                                                        <div class="col-md-8">
                                                            <input type="text" disabled disabled id="kelurahan_id" value="{{ $data->kelurahan->n_kelurahan }}" class="form-control r-0 s-12" autocomplete="off"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="date" disabled onchange="setDate()" value="{{ $data->tgl_skrd_awal }}" name="tgl_skrd_awal" id="tgl_skrd_awal" class="form-control r-0 s-12" autocomplete="off" required/>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="date" disabled name="tgl_ttd" id="tgl_ttd" value="{{ $data->tgl_ttd }}" class="form-control r-0 s-12" autocomplete="off" required/>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <label for="jumlah_bayar" class="col-form-label s-12 col-sm-4 text-right">Ketetapan<span class="text-danger ml-1">*</span></label>
                                                        <div class="col-md-8">
                                                            <input type="text" disabled name="jumlah_bayar" id="rupiah" value="{{ $data->jumlah_bayar }}" class="form-control r-0 s-12" autocomplete="off" required/>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
