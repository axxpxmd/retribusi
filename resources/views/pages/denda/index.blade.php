                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card no-b mb-2">
                            <div class="card-body">
                                ...
                                <div class="form-group row" style="margin-top: -8px !important">
                                    <label for="status_denda_filter" class="col-form-label s-12 col-md-3 text-right font-weight-bolder">Status Denda : </label>
                                    <div class="col-sm-8">
                                        <select name="status_denda_filter" id="status_denda_filter" class="select2 form-control r-0 light s-12">
                    ...
                    <div class="col-md-6">
                        <div class="card no-b mb-2">
                            <div class="card-body">
                                <div class="form-group row" style="margin-top: -8px !important">
                                    <label for="status_denda" class="col-form-label s-12 col-md-3 text-right font-weight-bolder">Denda<span class="text-danger ml-1">*</span> : </label>
                                    <div class="col-sm-8">
                                        <select name="status_denda" id="status_denda" class="select2 form-control r-0 light s-12">
                                            <option value="">Pilih</option>
                                ...
                                <div class="form-group row" style="margin-top: -8px !important">
                                    <label class="col-form-label s-12 col-md-3 text-right font-weight-bolder"></label>
                                    <div class="col-sm-5 row">
                                        <a href="#" data-toggle="modal" onclick="createRoute()" data-target="#exampleModalCenter" class="btn btn-sm btn-primary ml-3"><i class="icon-system_update_alt mr-2"></i>Update Denda</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        ajax: {
            ...
            data: function (data) {
                ...
                data.status_denda_filter = $('#status_denda_filter').val();
    ...
    function createRoute(){
        ...
        var status_denda_filter = $('#status_denda_filter').val();
        var no_skrd = $('#no_skrd').val();

        var status_denda = $('#status_denda').val();

        $('#exportpdf').attr('href', "{{ route('denda.updateDenda') }}?tgl_skrd=" + tgl_skrd + "&tgl_skrd1=" + tgl_skrd1 + "&opd_id=" + opd_id + "&jenis_pendapatan_id=" + jenis_pendapatan_id + "&status_denda_filter=" + status_denda_filter + "&status_denda=" + status_denda  + "&no_skrd=" + no_skrd)
    }
