                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <label class="col-md-3 s-12">
                                            <a target="blank" href="{{ route('skrd.create', array('data_wp_id' =>  Crypt::encrypt($datagit ->id))) }}" class="btn btn-sm btn-primary"><i class="icon-arrow_forward mr-2"></i>Buat SKRD</a>
                                        </label>
                                    </div> 
                                </div>
                            </div>
