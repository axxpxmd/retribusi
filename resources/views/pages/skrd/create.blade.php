                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="email" name="email" id="email" value="{{ $data_wp != null ? $data_wp->email : '' }}" class="form-control r-0 s-12" autocomplete="off"/>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <label for="no_telp" class="col-form-label s-12 col-sm-4 text-right">No WA</label>
                                            <div class="col-sm-8">
                                                <input type="number" name="no_telp" id="no_telp" value="{{ $data_wp != null ? $data_wp->no_telp : '' }}" class="form-control r-0 s-12" autocomplete="off" placeholder="contoh : 08xxxxx">
                                            </div>
                                        </div>
                                        <div class="row mb-1">
